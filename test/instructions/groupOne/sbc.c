 ...
 * 1. Accumulator: 0x00, Carry Flag: 1, Overflow Flag: 0, Zero Flag: 1, Negative Flag: 0 ->
 * FIRST_INSTRUCTION_TEST
 * 2. Accumulator: 0x0F, Carry Flag: 0, Overflow Flag: 0, Zero Flag: 0, Negative Flag: 0 ->
 * SECOND_INSTRUCTION_TEST 3 Accumulator: 0x8E, Carry Flag: 0, Overflow Flag: 1, Zero Flag: 0,
 * Negative Flag: 1 -> THIRD_INSTRUCTION_TEST
 */
...
#define THIRD_INSTRUCTION_TEST(addressing)                                               \
  {                                                                                      \
    ...
    TEST_ASSERT_EQUAL_HEX8_MESSAGE(0x8E, readA(&cpu), msg1);                             \
    TEST_ASSERT_EQUAL_HEX8_MESSAGE(0x00, readPS(&cpu) & CM, msg2);                       \
